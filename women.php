...
<div class="product-controls">
    <div class="category-filter">
        ...
        <a href="Shop.php" style="text-decoration: none;">
            <button class="category-btn " data-filter="all">
                All Shoes
            </button>
        </a>
...
<aside id="category-menu">
        ...
        <ul>
            ...
            <li><a href="Women_Boots.php">Boots</a></li>       
        </ul>
</aside>

    <!-- PRODUCTS -->
    <div class="pro-container" data-page="4">
</div>
...
@media (max-width: 768px) {
  ...
  #close { display: block; z-index: 201; }

  #header > div:first-of-type > div:not(#mobile) {
    display: none;
  }
}
...
.newstext .form button.normal:hover {
  background: #032e2b;
}
