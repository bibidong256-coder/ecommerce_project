...
<section id="product" class="section-p1">
    ...
    <div class="category-filter">
        ...
        <a href="Heels.php" style="text-decoration: none;">
        ...
        <a href="Flats.php" style="text-decoration: none;">
            <button class="category-btn" data-filter="women">
                Flats
            </button>
        </a>
        ...
        <a href="Women_boots.php" style="text-decoration: none;">
            <button class="category-btn" data-filter="Women">
                Boots
            </button>
        </a>
    ...
    <div class="pro-container" data-page="11">

    </div>

    <!-- View More Button -->
    <div class="btn-container">
        <a href="Women.php" class="view-more-btn">back</a>
    </div>
</section>
