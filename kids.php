...
<section id="header" >
    ...
    <h2>Kids' Shoes</h2>
    <p>Your Selection is our Command</p>
...
<!-- <aside id="category-menu">
        <h3>Category Menu for Women</h3>
        <ul>
            <li><a href="gental.html">Gentals</a></li>       
            <li><a href="sneakers.html">Sneakers</a></li>       
            <li><a href="Boot.html">Boots</a></li>       
        </ul>
    </aside> -->
<!-- PRODUCTS -->

    <div class="pro-container" data-page="5">
    </div>
...
<style>
    /* ═══════════════════════════════════════════════════════
   kids.css  —  Kids' Shop page
   Matches full site design system
   Primary:  #088178  |  Dark: #04534e
   Accent:   #e8f5f4  |  Body bg: #f9f9f9  |  Text: #333
════════════════════════════════════════════════════════ */
